    ...
    <Section id="beta" tone="white">
      <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-16">
        <Reveal className="lg:sticky lg:top-24">
          ...
          <p className="mt-4 text-pretty text-lg leading-relaxed text-ink-500">{betaPartner.sub}</p>
        ...
        <Reveal delay={80}>
          <div className="rounded-3xl border border-ink-100 bg-paper p-6 shadow-card sm:p-8">
            <DemoForm />
            <p className="mt-4 text-center text-xs text-ink-400">{disclaimers.beta}</p>
          </div>
        </Reveal>
      </div>
    </Section>
