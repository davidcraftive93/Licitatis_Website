  ...
  return (
    <Section tone="paper">
      ...
      <div className="mt-12 grid gap-6 lg:grid-cols-2">
        ...
        <Reveal delay={100}>
          <div className="relative h-full overflow-hidden rounded-3xl border border-brand-200 bg-brand-50/50 p-8 shadow-card ring-1 ring-brand-100">
            <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-brand text-white shadow-brand-glow">
              <Icon name="check" size={22} />
            </span>
            <h2 className="mt-4 text-xl font-semibold text-ink-900">{problemSolution.b.title}</h2>
            <p className="mt-3 text-base leading-relaxed text-ink-600">{problemSolution.b.body}</p>
          </div>
        </Reveal>
      </div>
    </Section>
