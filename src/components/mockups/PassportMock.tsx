...
/** Mock del Pasaporte del Licitador. Datos ficticios y neutrales (solo demostración). */
      ...
      <div className="mt-4 rounded-xl border border-ink-100 bg-paper p-3.5">
        <div className="flex items-end justify-between">
          <div>
            ...
            <p className="font-display text-3xl font-bold leading-none text-ink-900">
              82<span className="text-lg text-ink-300"> / 100</span>
            </p>
          </div>
          <span className="flex items-center gap-1 rounded-full bg-amber-50 px-2 py-0.5 text-2xs font-semibold text-amber-700 ring-1 ring-inset ring-amber-200">
